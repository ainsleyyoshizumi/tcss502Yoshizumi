...
class MyClockTests(unittest.TestCase):
    ...
    def test_hour_minute_second(self):
        ...
        self.assertEqual(10, clock.get_hour(), "hour was not 10")
        self.assertEqual(11, clock.get_minute(), "minute was not 11")
        self.assertEqual(12, clock.get_second(), "second was not 12")

    def test_set_hour_23(self):
        """Simple test to set hour to 23"""
        clock = Clock()
        clock.set_hour(23)
        self.assertEqual(23, clock.get_hour(), "hour not set to 23")
    ...
    def test_set_minute_59(self):
        ...
        clock = Clock()
        clock.set_minute(59)
        self.assertEqual(59, clock.get_minute(), "minute not set to 59")
    ...
    def test_set_second_59(self):
        ...
        clock = Clock()
        clock.set_second(59)
        self.assertEqual(59, clock.get_second(), "second not set to 59")
    ...
    def test_set_to_current_time(self):
        ...
        *******WARNING: Test can fail just before top of second, minute or hour!!!"""
        ...
        now = datetime.now()
        self.assertLessEqual(clock.get_hour(), now.hour)
        self.assertLessEqual(clock.get_minute(), now.minute)
        self.assertLessEqual(clock.get_second(), now.second)
        print(clock)
